...
enum cereal_CarEvent_EventName {
	cereal_CarEvent_EventName_commIssue = 0,
	...
	cereal_CarEvent_EventName_radarCommIssue = 15,
	...
	cereal_CarEvent_EventName_modelCommIssue = 27,
...
enum cereal_RadarData_Error {
	cereal_RadarData_Error_commIssue = 0,
...
enum cereal_CarParams_SafetyModels {
	cereal_CarParams_SafetyModels_noOutput = 0,
	cereal_CarParams_SafetyModels_honda = 1,
	cereal_CarParams_SafetyModels_toyota = 2,
	cereal_CarParams_SafetyModels_elm327 = 3,
	cereal_CarParams_SafetyModels_gm = 4,
	cereal_CarParams_SafetyModels_hondaBosch = 5,
	cereal_CarParams_SafetyModels_ford = 6,
	cereal_CarParams_SafetyModels_cadillac = 7,
	cereal_CarParams_SafetyModels_hyundai = 8,
	cereal_CarParams_SafetyModels_chrysler = 9,
	cereal_CarParams_SafetyModels_tesla = 10,
	cereal_CarParams_SafetyModels_subaru = 11
};
