...
const DBC honda_odyssey_extreme_edition_2018_china_can = {
  .name = "honda_odyssey_extreme_edition_2018_china_can",
...
dbc_init(honda_odyssey_extreme_edition_2018_china_can)